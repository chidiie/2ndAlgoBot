...
public sealed class FibonacciRetracementService : IFibonacciRetracementService
{
        ...
        FibonacciSettings settings)
    {
        ...
        var tolerance = PriceHelper.PipsToPriceDistance(specification, settings.ZoneTolerancePips);

        foreach (var candle in limitedCandles)
        {
        ...
        return FibonacciEvaluationResult.Fail(
            "No Fibonacci pullback confirmation found yet.",
            levels);
    }
